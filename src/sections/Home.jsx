...
import resume from "../assets/Akhil_Ramesh_Frontend_Developer.pdf";
  ...
  return (
    ...
    >
      <div className="text-center z-10 px-4">
        <img
          className="w-[200px] h-[200px] border-0 mt-20 rounded-full shadow-lg shadow-gray-500/70 lg:m-0 lg:w-[250px] lg:h-[250px] object-cover object-top hover:translate-y-1 transition-all "
          src={profile}
          alt="Profile Image"
        />
      </div>
      <div className="text-center font-mono z-10 px-4">
        <h1 className="text-4xl md:text-5xl lg:text-6xl lg:max-w[500px] font-semibold mb-6 px-1 bg-gradient-to-r from-teal-400 via-blue-500 to-indigo-600 bg-clip-text text-transparent leading-right ">
         Hi, I am Akhil Ramesh
        </h1>
        <p className="text-gray-300 text-lg mb-8 max-w-lg mx-auto">
         I’m a frontend developer who loves turning ideas into interactive web experiences. I build scalable, performance-driven applications with a strong emphasis on modern UI and intuitive user experiences.
        </p>
